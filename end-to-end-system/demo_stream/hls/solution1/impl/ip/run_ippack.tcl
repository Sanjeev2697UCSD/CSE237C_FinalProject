...
set Library     "hls"
set IPName      "e2e_system"
set Version     "1.0"
set DisplayName "E2e_system"
set Revision    "2112082207"
...
set xo_kernel_name "e2e_system"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/CSE237C/Project/end-to-end-system/demo_stream/hls/solution1"
set debug_dir "D:/CSE237C/Project/end-to-end-system/demo_stream/hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {e2e_system_fpext_32ns_64_2_no_dsp_1
...
e2e_system_fifo_w8_d2_S
e2e_system_fifo_w32_d2_S
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL output_signal input_signal"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 10032 II x}
...
source -notrace "D:/Vitis/2020.1/common/scripts/ipxhls.tcl"
