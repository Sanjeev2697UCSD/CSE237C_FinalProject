...
entity e2e_system_temp_data_ram is 
    generic(
...
architecture rtl of e2e_system_temp_data_ram is 
...
entity e2e_system_temp_data is
    generic (
...
architecture arch of e2e_system_temp_data is
    component e2e_system_temp_data_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    e2e_system_temp_data_ram_U :  component e2e_system_temp_data_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
