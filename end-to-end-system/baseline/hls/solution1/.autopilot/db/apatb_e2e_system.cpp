...
// wrapc file define:
#define AUTOTB_TVIN_output_signal "../tv/cdatafile/c.e2e_system.autotvin_output_signal.dat"
#define AUTOTB_TVOUT_output_signal "../tv/cdatafile/c.e2e_system.autotvout_output_signal.dat"
// wrapc file define:
#define AUTOTB_TVIN_input_signal "../tv/cdatafile/c.e2e_system.autotvin_input_signal.dat"
#define AUTOTB_TVOUT_input_signal "../tv/cdatafile/c.e2e_system.autotvout_input_signal.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_output_signal "../tv/rtldatafile/rtl.e2e_system.autotvout_output_signal.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_input_signal "../tv/rtldatafile/rtl.e2e_system.autotvout_input_signal.dat"
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {
            ((int*)__xlx_apatb_param_output_signal)[0] = output_signal_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
