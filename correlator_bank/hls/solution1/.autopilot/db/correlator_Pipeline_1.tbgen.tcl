set moduleName correlator_Pipeline_1
set isTopModule 0
...
set C_modelName {correlator_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ temp_input float 32 regular {array 31 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	temp_input { ap_memory {  { temp_input_address0 mem_address 1 5 }  { temp_input_ce0 mem_ce 1 1 }  { temp_input_we0 mem_we 1 1 }  { temp_input_d0 mem_din 1 32 } } }
}
