...
entity correlator_codebook_4 is 
    generic(
...
architecture rtl of correlator_codebook_4 is 

signal address0_tmp : std_logic_vector(AddressWidth-1 downto 0); 
type mem_array is array (0 to AddressRange-1) of std_logic_vector (DataWidth-1 downto 0); 
signal mem : mem_array := (
    0 to 2=> "00111111100000000000000000000000", 
    3 to 4=> "10111111100000000000000000000000", 
    5 to 6=> "00111111100000000000000000000000", 
    7 => "10111111100000000000000000000000", 
    8 to 9=> "00111111100000000000000000000000", 
    10 to 14=> "10111111100000000000000000000000", 
    15 => "00111111100000000000000000000000", 
    16 to 18=> "10111111100000000000000000000000", 
    19 to 21=> "00111111100000000000000000000000", 
