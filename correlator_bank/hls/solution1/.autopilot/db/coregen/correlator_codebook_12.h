...
// ==============================================================
#ifndef __correlator_codebook_12_H__
#define __correlator_codebook_12_H__
...
struct correlator_codebook_12_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_12_ram) {
        ram[0] = "0b00111111100000000000000000000000";
        for (unsigned i = 1; i < 7 ; i = i + 1) {
...
SC_MODULE(correlator_codebook_12) {
...
correlator_codebook_12_ram* meminst;


SC_CTOR(correlator_codebook_12) {
meminst = new correlator_codebook_12_ram("correlator_codebook_12_ram");
