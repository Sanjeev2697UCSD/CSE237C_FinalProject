...
// ==============================================================
#ifndef __correlator_codebook_3_H__
#define __correlator_codebook_3_H__
...
struct correlator_codebook_3_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_3_ram) {
...
SC_MODULE(correlator_codebook_3) {
...
correlator_codebook_3_ram* meminst;


SC_CTOR(correlator_codebook_3) {
meminst = new correlator_codebook_3_ram("correlator_codebook_3_ram");
