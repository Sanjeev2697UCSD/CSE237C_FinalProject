...
// ==============================================================
#ifndef __correlator_codebook_6_H__
#define __correlator_codebook_6_H__
...
struct correlator_codebook_6_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_6_ram) {
...
SC_MODULE(correlator_codebook_6) {
...
correlator_codebook_6_ram* meminst;


SC_CTOR(correlator_codebook_6) {
meminst = new correlator_codebook_6_ram("correlator_codebook_6_ram");
