...
// ==============================================================
#ifndef __correlator_codebook_5_H__
#define __correlator_codebook_5_H__
...
struct correlator_codebook_5_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_5_ram) {
...
SC_MODULE(correlator_codebook_5) {
...
correlator_codebook_5_ram* meminst;


SC_CTOR(correlator_codebook_5) {
meminst = new correlator_codebook_5_ram("correlator_codebook_5_ram");
