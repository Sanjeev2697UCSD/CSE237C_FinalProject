...
// ==============================================================
#ifndef __correlator_codebook_8_H__
#define __correlator_codebook_8_H__
...
struct correlator_codebook_8_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_8_ram) {
...
SC_MODULE(correlator_codebook_8) {
...
correlator_codebook_8_ram* meminst;


SC_CTOR(correlator_codebook_8) {
meminst = new correlator_codebook_8_ram("correlator_codebook_8_ram");
