...
// ==============================================================
#ifndef __correlator_codebook_2_H__
#define __correlator_codebook_2_H__
...
struct correlator_codebook_2_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_2_ram) {
...
SC_MODULE(correlator_codebook_2) {
...
correlator_codebook_2_ram* meminst;


SC_CTOR(correlator_codebook_2) {
meminst = new correlator_codebook_2_ram("correlator_codebook_2_ram");
