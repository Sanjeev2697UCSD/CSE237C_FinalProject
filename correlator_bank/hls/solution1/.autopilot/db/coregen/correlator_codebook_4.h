...
// ==============================================================
#ifndef __correlator_codebook_4_H__
#define __correlator_codebook_4_H__
...
struct correlator_codebook_4_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_4_ram) {
...
SC_MODULE(correlator_codebook_4) {
...
correlator_codebook_4_ram* meminst;


SC_CTOR(correlator_codebook_4) {
meminst = new correlator_codebook_4_ram("correlator_codebook_4_ram");
