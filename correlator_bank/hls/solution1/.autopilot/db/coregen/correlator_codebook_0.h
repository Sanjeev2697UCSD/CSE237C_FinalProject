...
// ==============================================================
#ifndef __correlator_codebook_0_H__
#define __correlator_codebook_0_H__
...
struct correlator_codebook_0_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_0_ram) {
...
SC_MODULE(correlator_codebook_0) {
...
correlator_codebook_0_ram* meminst;


SC_CTOR(correlator_codebook_0) {
meminst = new correlator_codebook_0_ram("correlator_codebook_0_ram");
