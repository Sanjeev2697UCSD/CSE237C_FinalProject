...
// ==============================================================
#ifndef __correlator_codebook_7_H__
#define __correlator_codebook_7_H__
...
struct correlator_codebook_7_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_7_ram) {
...
SC_MODULE(correlator_codebook_7) {
...
correlator_codebook_7_ram* meminst;


SC_CTOR(correlator_codebook_7) {
meminst = new correlator_codebook_7_ram("correlator_codebook_7_ram");
