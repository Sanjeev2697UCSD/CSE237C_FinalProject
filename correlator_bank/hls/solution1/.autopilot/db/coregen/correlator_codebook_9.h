...
// ==============================================================
#ifndef __correlator_codebook_9_H__
#define __correlator_codebook_9_H__
...
struct correlator_codebook_9_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_9_ram) {
...
SC_MODULE(correlator_codebook_9) {
...
correlator_codebook_9_ram* meminst;


SC_CTOR(correlator_codebook_9) {
meminst = new correlator_codebook_9_ram("correlator_codebook_9_ram");
