...
// ==============================================================
#ifndef __correlator_codebook_16_H__
#define __correlator_codebook_16_H__
...
struct correlator_codebook_16_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(correlator_codebook_16_ram) {
...
SC_MODULE(correlator_codebook_16) {
...
correlator_codebook_16_ram* meminst;


SC_CTOR(correlator_codebook_16) {
meminst = new correlator_codebook_16_ram("correlator_codebook_16_ram");
