...
entity correlator_correlator_Pipeline_Inner_Loop15 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    r_V_30 : IN STD_LOGIC_VECTOR (29 downto 0);
...
architecture behav of correlator_correlator_Pipeline_Inner_Loop15 is 
...
attribute shreg_extract : string;
    ...
    signal r_V_30_cast_fu_84_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal r_V_30_cast_reg_161 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_16_fu_44 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln47_fu_102_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal lhs_22_fu_127_p3 : STD_LOGIC_VECTOR (34 downto 0);
    ...
    component correlator_correlator_Pipeline_Inner_Loop15_codebook_V_15 IS
    generic (
        DataWidth : INTEGER;
...
begin
    codebook_V_15_U : component correlator_correlator_Pipeline_Inner_Loop15_codebook_V_15
    generic map (
        DataWidth => 2,
        AddressRange => 33,
        AddressWidth => 6)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                r_V_30_cast_reg_161 <= r_V_30_cast_fu_84_p1;
                tmp_reg_181 <= codebook_V_15_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_16_fu_44, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i <= ap_const_lv6_0;
        else 
            ap_sig_allocacmp_i <= i_16_fu_44;
        end if; 
    end process;

    codebook_V_15_address0 <= zext_ln47_fu_108_p1(6 - 1 downto 0);
    ...
    grp_fu_1532_p_din0 <= r_V_30_cast_reg_161(30 - 1 downto 0);
    grp_fu_1532_p_din1 <= sext_ln1171_fu_119_p1(2 - 1 downto 0);
    icmp_ln47_fu_96_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv6_21) else "0";
    lhs_22_fu_127_p3 <= (lhs_reg_186_pp0_iter3_reg & ap_const_lv5_0);
        r_V_30_cast_fu_84_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(r_V_30),32));

    ret_V_fu_137_p2 <= std_logic_vector(unsigned(lhs_22_fu_127_p3) + unsigned(sext_ln1245_fu_134_p1));
