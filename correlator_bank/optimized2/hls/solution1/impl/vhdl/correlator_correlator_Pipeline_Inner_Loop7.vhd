...
entity correlator_correlator_Pipeline_Inner_Loop7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln46_9 : IN STD_LOGIC_VECTOR (7 downto 0);
    r_V_7 : IN STD_LOGIC_VECTOR (29 downto 0);
...
architecture behav of correlator_correlator_Pipeline_Inner_Loop7 is 
...
attribute shreg_extract : string;
    ...
    signal r_V_7_cast_fu_98_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal r_V_7_cast_reg_206 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_2_7_load_reg_211 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_2_7_load_reg_211_pp0_iter1_reg : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal zext_ln455_1_fu_150_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln46_fu_160_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_2_7_fu_52 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_2_7_load : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln46_fu_116_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln455_fu_126_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_8_cast_fu_130_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal shl_ln737_7_fu_172_p3 : STD_LOGIC_VECTOR (34 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                acc_V_addr_reg_235 <= zext_ln46_fu_160_p1(6 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                i_2_7_load_reg_211 <= ap_sig_allocacmp_i_2_7_load;
                i_2_7_load_reg_211_pp0_iter1_reg <= i_2_7_load_reg_211;
                r_V_7_cast_reg_206 <= r_V_7_cast_fu_98_p1;
            end if;
        end if;
    end process;
    ...
    acc_V_address1 <= zext_ln46_fu_160_p1(6 - 1 downto 0);
    ...
    add_ln1245_fu_182_p2 <= std_logic_vector(unsigned(shl_ln737_7_fu_172_p3) + unsigned(sext_ln1245_fu_179_p1));
    add_ln455_fu_144_p2 <= std_logic_vector(unsigned(sub_ln455_fu_138_p2) + unsigned(zext_ln46_9));
    add_ln46_fu_116_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2_7_load) + unsigned(ap_const_lv6_1));
    ...
    ap_sig_allocacmp_i_2_7_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_2_7_fu_52, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_2_7_load <= ap_const_lv6_0;
        else 
            ap_sig_allocacmp_i_2_7_load <= i_2_7_fu_52;
        end if; 
    end process;

    codebook_V_3_address0 <= zext_ln455_1_fu_150_p1(8 - 1 downto 0);
    ...
    grp_fu_1953_p_din0 <= r_V_7_cast_reg_206(30 - 1 downto 0);
    grp_fu_1953_p_din1 <= sext_ln1171_fu_164_p1(2 - 1 downto 0);
    icmp_ln46_fu_110_p2 <= "1" when (ap_sig_allocacmp_i_2_7_load = ap_const_lv6_21) else "0";
        r_V_7_cast_fu_98_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(r_V_7),32));
    ...
    shl_ln737_7_fu_172_p3 <= (acc_V_load_reg_246 & ap_const_lv5_0);
    sub_ln455_fu_138_p2 <= std_logic_vector(unsigned(tmp_8_cast_fu_130_p3) - unsigned(zext_ln455_fu_122_p1));
    tmp_8_cast_fu_130_p3 <= (trunc_ln455_fu_126_p1 & ap_const_lv3_0);
    trunc_ln455_fu_126_p1 <= ap_sig_allocacmp_i_2_7_load(5 - 1 downto 0);
    zext_ln455_1_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln455_fu_144_p2),64));
    zext_ln455_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_2_7_load),8));
    zext_ln46_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_2_7_load_reg_211_pp0_iter1_reg),64));
end behav;
