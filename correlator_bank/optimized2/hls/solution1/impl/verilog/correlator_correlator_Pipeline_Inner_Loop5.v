...
module correlator_correlator_Pipeline_Inner_Loop5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire  signed [31:0] r_V_5_cast_fu_98_p1;
reg  signed [31:0] r_V_5_cast_reg_192;
wire    ap_block_pp0_stage0_11001;
reg   [5:0] i_2_5_load_reg_197;
reg   [5:0] i_2_5_load_reg_197_pp0_iter1_reg;
...
reg   [5:0] i_2_5_fu_52;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i_2_5_load;
wire   [5:0] add_ln46_fu_116_p2;
wire   [8:0] tmp_6_fu_122_p3;
wire   [8:0] add_ln455_fu_130_p2;
wire   [34:0] shl_ln737_5_fu_158_p3;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_2_5_load = 6'd0;
    end else begin
...
assign add_ln1245_fu_168_p2 = ($signed(shl_ln737_5_fu_158_p3) + $signed(sext_ln1245_fu_165_p1));

assign add_ln455_fu_130_p2 = (tmp_6_fu_122_p3 + zext_ln46_5);

assign add_ln46_fu_116_p2 = (ap_sig_allocacmp_i_2_5_load + 6'd1);
...
assign grp_fu_1953_p_din0 = r_V_5_cast_reg_192;

assign grp_fu_1953_p_din1 = sext_ln1171_fu_150_p1;

assign icmp_ln46_fu_110_p2 = ((ap_sig_allocacmp_i_2_5_load == 6'd33) ? 1'b1 : 1'b0);

assign r_V_5_cast_fu_98_p1 = $signed(r_V_5);

assign sext_ln1171_fu_150_p1 = $signed(codebook_V_1_load_reg_211);

assign sext_ln1245_fu_165_p1 = $signed(mul_ln1171_reg_227);

assign shl_ln737_5_fu_158_p3 = {{acc_V_load_reg_232}, {5'd0}};

assign tmp_6_fu_122_p3 = {{ap_sig_allocacmp_i_2_5_load}, {3'd0}};

assign zext_ln455_fu_136_p1 = add_ln455_fu_130_p2;

assign zext_ln46_fu_146_p1 = i_2_5_load_reg_197_pp0_iter1_reg;

endmodule //correlator_correlator_Pipeline_Inner_Loop5
