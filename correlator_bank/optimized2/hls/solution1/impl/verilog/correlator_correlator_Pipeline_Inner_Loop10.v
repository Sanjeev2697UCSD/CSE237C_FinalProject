...
module correlator_correlator_Pipeline_Inner_Loop10 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [31:0] r_V_20_cast_fu_84_p1;
reg  signed [31:0] r_V_20_cast_reg_161;
...
correlator_correlator_Pipeline_Inner_Loop10_codebook_V_10 #(
    .DataWidth( 2 ),
    .AddressRange( 33 ),
    .AddressWidth( 6 ))
codebook_V_10_U(
...
assign codebook_V_10_address0 = zext_ln47_fu_108_p1;

assign grp_fu_1532_p_ce = 1'b1;

assign grp_fu_1532_p_din0 = r_V_20_cast_reg_161;

assign grp_fu_1532_p_din1 = sext_ln1171_fu_119_p1;

assign icmp_ln47_fu_96_p2 = ((ap_sig_allocacmp_i == 6'd33) ? 1'b1 : 1'b0);

assign lhs_27_fu_127_p3 = {{lhs_reg_186_pp0_iter3_reg}, {5'd0}};

assign r_V_20_cast_fu_84_p1 = $signed(r_V_20);

assign ret_V_fu_137_p2 = ($signed(lhs_27_fu_127_p3) + $signed(sext_ln1245_fu_134_p1));
...
endmodule //correlator_correlator_Pipeline_Inner_Loop10
