...
module correlator_correlator_Pipeline_VITIS_LOOP_53_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln53_fu_155_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_CS_fsm_state8;
wire    ap_block_state8_pp0_stage7_iter0;
reg   [0:0] icmp_ln53_reg_691;
wire   [5:0] add_ln53_fu_161_p2;
reg   [5:0] add_ln53_reg_695;
reg   [31:0] output_signal_read_reg_700;
wire   [31:0] bitcast_ln54_fu_172_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        i_fu_114 <= 6'd0;
    end else if (((icmp_ln53_reg_691 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln53_reg_691 == 1'd0) & (1'b1 == ap_CS_fsm_state6) & (icmp_ln988_reg_799 == 1'd0) & (icmp_ln1547_reg_795 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln53_reg_691 == 1'd0) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln988_reg_799 == 1'd0) & (icmp_ln1547_reg_795 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln53_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln53_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln53_reg_691 == 1'd0) & (1'b1 == ap_CS_fsm_state8) & (icmp_ln1547_reg_795 == 1'd1))) begin
...
assign add_ln53_fu_161_p2 = (ap_sig_allocacmp_i_1 + 6'd1);
...
assign bitcast_ln54_fu_172_p1 = output_signal_i;

assign grp_fu_670_p_ce = 1'b1;

assign grp_fu_670_p_din0 = bitcast_ln54_fu_172_p1;
...
assign icmp_ln53_fu_155_p2 = ((ap_sig_allocacmp_i_1 == 6'd33) ? 1'b1 : 1'b0);
...
assign ireg_fu_177_p1 = grp_fu_670_p_dout0;
...
endmodule //correlator_correlator_Pipeline_VITIS_LOOP_53_2
