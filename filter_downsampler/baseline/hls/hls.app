<project xmlns="com.autoesl.autopilot.project" name="hls" top="filter">
    <includePaths/>
    <libraryPaths/>
    <libraryFlag/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="../../filter_test.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="filter.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="filter.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
